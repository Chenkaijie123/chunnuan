  ...
  <div class='app'>
    <router-link to="/bookwindow">
      <div class="showImg" v-if="bestData.datas">
        <ul ref="supports" class='ban'>
          <li v-for="item in bestData.datas.banner.concat([bestData.datas.banner[0]])" :key="item.id"
              @click="getBookwindowData(item)"><img :src='item.image' alt=""></li>
        </ul>
      </div>
    </router-link>
    <div class="main" v-if="bestData.datas">
      <div class="box">
        ...
        <div class="body">
          <div class="body-pic" @click="getBookwindowData(bestData.datas.list[0].data[0])">
            <router-link to="/bookwindow">
              <img :src="bestData.datas.list[0].data[0].image" alt="">
            </router-link>
          </div>
          <div class="body-dec">
      ...
      <div class="all-book" v-for="(item,index) in bestData.datas.list">
        <div class="book-box" v-if="index!=0&&index!=3">
        ...
        <!--男女-->
        <div class="book-box－boy" v-if="index==3">
          <div class="title-name">
            <div class="name-nav">{{item.title}}</div>
          </div>
          <div class="book-show" v-for="key in item.data">
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      ajax.open('get', 'http://api.reader.ibczy.com/api/home.feature?data={%22columnId%22:6,%22gender%22:1,%22pageNo%22:1,%22pageSize%22:20}', true);
      ajax.send()
    },
    watch: {
      bestData(val) {
